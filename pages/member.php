...
switch($tipe){
    ...
    case 'Hapus':{
      for ($i=0; $i < sizeof($member_cb) ; $i++) {
        $query = "delete from $tableName where id = '".$member_cb[$i]."'";
        sqlQuery($query);
      }
    ...
    case 'Edit':{
      ...
      $content = array("idEdit" => $member_cb[0]);
      echo generateAPI($cek,$err,$content);
    break;
    }
    ...
    case 'loadTable':{
      ...
      $getData = sqlQuery("SELECT * from $tableName where jenis_user = '1'  $kondisi $kondisiSort $queryLimit");
        ...
        <thead>
          <tr>
            ...
            <th class='text-center'>
             <div class='checkbox checkbox-inline checkbox-styled' >
              <label>
                <input type='checkbox' name='member_toogle' id='member_toogle' onclick=checkSemua($nomorCB,'member_cb','member_toogle','member_jmlcek',this)>
              <span></span>
            </label>
          </div>
            </th>
      ...
      <input type='hidden' name='member_jmlcek' id='member_jmlcek' value='0'>";
    ...
    break;
     ...
     default:{
        ?>
        <script>
        var url = "http://"+window.location.hostname+"/api.php?page=member";
        </script>
            ...
            <div id="content">
      				<section>
      					<div class="section-body contain-lg">
                            ...
                            <form id='formmember' name="formmember" action="#">
